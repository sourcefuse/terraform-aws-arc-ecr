...
|------|-------------|------|---------|:--------:|
| <a name="input_account_setting_name"></a> [account\_setting\_name](#input\_account\_setting\_name) | ECR account setting name | `string` | `null` | no |
| <a name="input_account_setting_value"></a> [account\_setting\_value](#input\_account\_setting\_value) | ECR account setting value | `string` | `null` | no |
| <a name="input_enable_registry_scanning"></a> [enable\_registry\_scanning](#input\_enable\_registry\_scanning) | Enable registry scanning configuration | `bool` | `false` | no |
...
| <a name="input_registry_scanning_configuration"></a> [registry\_scanning\_configuration](#input\_registry\_scanning\_configuration) | Registry scanning configuration | <pre>object({<br/>    scan_type = optional(string, "ENHANCED")<br/>    rules = optional(list(object({<br/>      scan_frequency = string<br/>      repository_filters = list(object({<br/>        filter      = string<br/>        filter_type = string<br/>      }))<br/>    })), [])<br/>  })</pre> | <pre>{<br/>  "rules": [],<br/>  "scan_type": "ENHANCED"<br/>}</pre> | no |
